            ...
            <div class="mb-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Update order information and synchronize the changes with BUSY.
                    </p>
            ...
            @if ($order->busyorder_id)
                <div class="mb-5 rounded-xl border border-blue-200 bg-blue-50 p-4">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="mt-0.5 rounded-full bg-blue-100 p-2">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-blue-700">
                                This order is already linked with BUSY voucher
                                <span class="font-semibold">
                                    #{{ $order->busyorder_id }}
                                </span>.
                                Saving changes will update the existing BUSY voucher instead of creating a new one.
                            </p>
                ...
                ================================================== --}}
                    ...
                    <div class="border-b border-slate-200 p-5 sm:p-6">
                        ...
                        <div class="mb-5">
                            ...
                            <p class="mt-1 text-sm text-slate-500">
                                Update the customer and basic order information.
                            </p>
                    ...
                    <div class="p-5 sm:p-6">
                        ...
                        <div class="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-slate-500">
                                    Modify products, quantity, rate, discount and tax.
                                </p>
                        ...
                        <div class="overflow-hidden rounded-xl border border-slate-200">
                            ...
                            <div id="emptyProducts"
                                class="hidden flex min-h-[180px] flex-col items-center justify-center bg-slate-50 px-6 text-center">
                        ...
                        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                            ...
                            <div>
                                ...
                                <textarea id="order_notes" name="order_notes" rows="8"
                                    ...
                                    class="block w-full resize-y rounded-xl border border-slate-300 px-4 py-3 text-sm text-slate-800 shadow-sm outline-none transition placeholder:text-slate-400 focus:border-teal-500 focus:ring-2 focus:ring-teal-100">{{ old('order_notes', $order->order_notes) }}</textarea>
                                    ...
                                    <div class="border-t border-slate-200 pt-4">
                                        ...
                                        <div class="flex">
                                            ...
                                            <input type="number" step="0.01" min="0" id="delivery_charge"
                                                ...
                                                value="{{ old('delivery_charge', $order->delivery_charge ?? 0) }}"
                ...
                ================================================== --}}
                    ...
                    <div
                        ...
                        <button type="submit" id="updateOrderBtn"
                            class="inline-flex items-center justify-center gap-2 rounded-lg bg-teal-600 px-6 py-2.5 font-semibold text-white shadow-sm transition hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-300">
...
============================================================== --}}
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const updateButton =
                document.getElementById('updateOrderBtn');
            ...
            */
            ...
            function handleProductChange(row) {
                ...
                /*
                | Only auto-fill rate/unit when product is selected.
                */
